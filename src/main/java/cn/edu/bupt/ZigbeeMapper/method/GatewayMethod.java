...
public interface GatewayMethod {
  ...
  void getGatewayInfo(String IP) throws Exception;

  void getDeviceState(Device device,String IP);

  void getDeviceBright(Device device,String IP);
//
  void getDeviceHue(Device device,String IP);
//
...
//
//  // 修改设备名
  void changeDeviceName(Device device, String name,String IP);
//
//  //删除指定设备
  void deleteDevice(Device device, String IP);
//
//  //设置指定设备的开关状态
  void setDeviceState(Device controlDevice, byte state,String IP);
//
//  //设置指定设备的开关状态
...
//
//  // 获取设备信息
  void getDeviceInfo(Device device,String IP);
//
//  // 修改场景名
...
//  void cancelBindOfSwitchAndScene_CallBack();
  ...
  void device_CallBack(Device device, String IP,DeviceTokenRelationService deviceTokenRelationService) throws Exception;
